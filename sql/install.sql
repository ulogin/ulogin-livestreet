...
CREATE TABLE  IF NOT EXISTS  `prefix_ulogin_settings` (
  `ulogin_id` TEXT  CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL, 
  `ulogin_value` TEXT  CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY(`ulogin_id`(255))
)ENGINE = InnoDB  DEFAULT CHARSET=utf8;
